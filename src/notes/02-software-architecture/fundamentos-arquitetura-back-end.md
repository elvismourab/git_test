# Fundamentos de Arquitetura Back-end

## 🎯 Objetivo

Este guia de estudo aborda os conceitos essenciais do desenvolvimento back-end, desde a sua definição e arquitetura básica até a estrutura detalhada de uma aplicação em camadas, explicando o ciclo de vida de uma requisição e a responsabilidade de cada componente.

## 📝 Resumo

O back-end é a camada lógica de uma aplicação, responsável por processar dados, interagir com o banco de dados e se comunicar com o front-end através de APIs. Uma arquitetura back-end modular, baseada na separação de responsabilidades, organiza o código em componentes como Controllers, Services, e Repositories. Esse modelo torna a aplicação mais escalável, manutenível e testável, seguindo um fluxo de requisição claro e desacoplado.
...
### 6. O Ciclo de Vida de uma Requisição: Os Componentes em Ação

Um back-end bem projetado não é um único bloco de código, mas sim um conjunto de componentes especializados que trabalham em harmonia. Essa arquitetura, baseada na **separação de responsabilidades (Separation of Concerns)**, torna o código mais escalável, fácil de manter, de testar e de depurar.

#### 6.1. Controllers/Routes: A Central de Atendimento
...
#### 6.2. DTOs (Data Transfer Objects): Os Malotes de Dados
...
#### 6.3. Services: O Coração da Lógica de Negócio
...
#### 6.4. Repositories/DAOs (Data Access Objects): O Acesso ao Banco de Dados
...
#### 6.5. Entities/Models: A Representação dos Dados
...
#### 6.6. Interfaces: O Contrato de Colaboração
...
#### 6.7. Modules: A Organização do Projeto
...
#### 6.8. Interceptors/Middlewares: O Intermediário Silencioso
...
### 7. Fluxo de uma Requisição: O Caminho dos Dados
